          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex gap-4">
               <a 
                ...
                className="w-10 h-10 bg-gray-900 dark:bg-white/5 rounded-full flex items-center justify-center hover:bg-martial-red transition-colors"
                  ...
                  return (
                    <li key={link.name}>
                      <a 
                        ...
                        className="text-gray-400 dark:text-gray-500 hover:text-martial-red transition-colors text-sm font-medium"
                      >
                        {link.name}
                      </a>
                    </li>
