      ...
      {isVisible && (
        ...
        >
          <div className="max-w-4xl mx-auto pointer-events-auto w-full">
            <div className="bg-martial-black text-white p-4 md:px-10 md:py-5 rounded-[2.5rem] shadow-2xl flex flex-col lg:flex-row items-center justify-between gap-6 border border-white/10 backdrop-blur-md bg-opacity-95">
              ...
              <div className="flex flex-col md:flex-row items-center gap-6 lg:gap-10 w-full lg:w-auto flex-shrink-0">
