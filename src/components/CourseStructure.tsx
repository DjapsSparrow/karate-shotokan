  ...
  return (
    <motion.div
      ...
      className={`group bg-martial-gray rounded-3xl p-6 transition-all duration-300 border border-transparent ${
        isOpen ? 'bg-white dark:bg-black/40 shadow-xl shadow-black/5 border-gray-100 dark:border-white/10' : 'hover:bg-white dark:hover:bg-white/5 hover:shadow-lg'
      }`}
    >
      <button 
      ...
      >
        <div className="flex items-center gap-4">
          <span className="flex-shrink-0 w-8 h-8 bg-white dark:bg-zinc-800 text-martial-red font-black text-[10px] flex items-center justify-center rounded-full shadow-sm">
            {lesson.number}
          </span>
        ...
        <div className={`w-8 h-8 rounded-full flex items-center justify-center transition-all ${isOpen ? 'bg-martial-red text-white rotate-180' : 'bg-white dark:bg-zinc-800 text-gray-400 dark:text-gray-500 group-hover:text-martial-red'}`}>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-black uppercase tracking-tighter text-martial-red leading-none mb-4">
              Structure <br /> <span className="text-martial-black dark:text-white">des formations</span>
            </h2>
